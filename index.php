            ...
            <section class="w-3/4 ml-80 flex flex-col items-center">
                ...
                <div class="w-1/2">
                    ...
                    <div class="bg-stone-800 rounded-xl my-5">
                        ...
                        <div class="flex justify-between">
                            <div class="author px-5 py-3 flex items-center">
                                <img src="image/defaultprofile.jpg" alt="" class="max-w-10 rounded-full">
                                <div>
                                    <p class="font-normal ml-3">Htet Aung Lwin</p>
                                    <p class="text-xs font-light ml-3">2 hours ago</p>
                                </div>
                            </div>
                            <!-- dropdown start -->
                            <div class="relative px-5 py-3 select-none">
                                <div class="cursor-pointer hover:bg-stone-600 rounded-lg transition ease-in-out duration-300 px-1" id="dropdown-btn" onclick="dropdown()">
                                ...
                                <div class="absolute text-right -left-24 bg-stone-700 flex rounded-lg mt-2 opacity-0 transition-opacity duration-300 ease-in-out" id="dropdown">
                                    <a href="">
                                        <div class="px-5 py-2 hover:bg-stone-600 rounded-lg transition ease-in-out duration-300">Edit</div>
                                    </a>
                                    <a href="">
                                        <div class="px-5 py-2 hover:bg-stone-600 rounded-lg transition ease-in-out duration-300">Delete</div>
                                    </a>
                                </div>
                                <script>
                                    function dropdown() {
                        ...
                        <!-- caption -->
                        <p class="px-5 pb-3">refaela is real</p>
                        <!-- image -->
                        <a href="">
                            <img src="./image/Screenshot (3).png" alt="" class="max-w-full w-full max-h-[500px] object-cover">
                        </a>
                        <!-- like -->
                    ...
                    <div class="bg-stone-800 rounded-xl my-5">
                        ...
                        <!-- image -->
                        <a href="">
                            <img src="./image/rafaela-saber-savior-skin.jpg" alt="" class="max-w-full w-full max-h-[500px] object-cover">
                        </a>
                        <!-- like -->
                        <div class="px-5 py-3 flex gap-5">
                            <button class="">
                    ...
                    <div class="bg-stone-800 rounded-xl my-5">
                        ...
                        <!-- image -->
                        <a href="">
                            <img src="./image/roger-phantom-ranger.jpg" alt="" class="max-w-full w-full max-h-[500px] object-cover">
                        </a>
                        <!-- like -->
                        <div class="px-5 py-3 flex gap-5">
                            <button class="">
